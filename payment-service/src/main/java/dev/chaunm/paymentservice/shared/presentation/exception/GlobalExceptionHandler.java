package dev.chaunm.paymentservice.shared.presentation.exception;

import dev.chaunm.paymentservice.shared.domain.exception.CommonErrorCode;
...
/**
 * Translates payment-service domain exceptions into RFC 7807 problem responses, so controllers
 * stay free of HTTP-status decisions. This class is a presentation/web concern (Spring MVC
 * advice) and therefore lives outside {@code domain} packages, which must stay framework-free.
 */
